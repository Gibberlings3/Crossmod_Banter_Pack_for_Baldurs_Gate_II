...
!StateCheck("Keto",CD_STATE_NOTVALID)~ THEN ~I'll drink to that.~
END
...
== FWKETOJ IF ~!AreaCheck("AR2000")~ THEN ~Although if you ask me, the Copper Coronet would perhaps be a good place to start.  There are always these suspicious fellows hanging around there, buying a girl a drink and trying to lure them into a dark alleyway.  I've seen many fall into that ruse and never come back.~
== FWKETOJ IF ~AreaCheck("AR2000")~ THEN ~It might get us nowhere, but they must have a mayor or something.  He might be able to point us in the right direction.~
EXIT
