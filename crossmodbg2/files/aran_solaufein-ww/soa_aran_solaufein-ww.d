/* SoA Banters: Aran<>Solaufein : cmorgan "sola" dv */
...
THEN C-ARANB c-aran1solaufeintalk_soladv
@0 /* [ARAN] So I hear you be a "good" Drow. */
DO ~SetGlobal("c-aran1solaufein","GLOBAL",1)~
== BSOLA @1 /* [SOLAUFEIN] Yes, it would appear so. */
== C-ARANB @2 /* [ARAN] Didn't know there were any such thing. */
== BSOLA @3 /* [SOLAUFEIN] I assure you, I am. I exist, and I am not alone. */
...
== BSOLA @5 /* [SOLAUFEIN] Perhaps you are correct. But the followers of Eilistraee, Lady Silverhair, must be discreet if we are to guide our brothers and sisters to a lighter path. */
== C-ARANB @6 /* [ARAN] This Ellyartrie... */
== BSOLA @7 /* [SOLAUFEIN] Eilistraee. */
== C-ARANB @8 /* [ARAN] Look, do there be many followers o' Her particular brand o' Drowdom? */
== BSOLA @9 /* [SOLAUFEIN] Very few, I am afraid. */
...
== BSOLA @11 /* [SOLAUFEIN] Ah, my friend, for a brief moment I thought that you would see past your prejudice rather that rationalize your past actions. I will sing a prayer to Lady of the Dance for you. */
EXIT

/* SoA Banters: Aran<>Solaufein : cmorgan "solaufein" dv */
CHAIN IF ~Global("c-aran1solaufein","GLOBAL",0)
InParty(Myself) !StateCheck(Myself,CD_STATE_NOTVALID)
InParty("SOLAUFEIN") InMyArea("SOLAUFEIN") !StateCheck("SOLAUFEIN",CD_STATE_NOTVALID)
CombatCounter(0) !See([ENEMY])~ 
THEN C-ARANB c-aran1solaufeintalk_solaufeindv
@0 /* [ARAN] So I hear you be a "good" Drow. */
DO ~SetGlobal("c-aran1solaufein","GLOBAL",1)~
== BSOLA @1 /* [SOLAUFEIN] Yes, it would appear so. */
== C-ARANB @2 /* [ARAN] Didn't know there were any such thing. */
...
/* SoA Banters: Solaufein<>Aran : cmorgan : "sola" dv */
...
== BSOLA @13 /* [SOLAUFEIN] Ah, my prejudiced fellow traveller - speech is a mirror of the soul. As a man speaks, so is he. I ask you now: who is Aran? */
...
== BSOLA @15 /* [SOLAUFEIN] Why, yes. I think that is a fair assessment. */
...
== BSOLA @17 /* [SOLAUFEIN] I do not think that will be a fair picture. With your scribing, you have time to think, to craft your ideas. In your speech, there is an immediacy that shows a raw truth. */
== C-ARANB @18 /* [ARAN] Mayhap. Or mayhap we have to agree to disagree, eh? */
== BSOLA @19 /* [SOLAUFEIN] I can convince you with a simple example, if you would like. */
== C-ARANB @20 /* [ARAN] Aye, then, go ahead an' try. */
== BSOLA @21 /* [SOLAUFEIN] Have you ever known a Drow to communicate through poetry and song? */
...
/* SoA Banters: Solaufein<>Aran : cmorgan : "solaufein" dv */
CHAIN IF ~Global("c-solaufein1aran","GLOBAL",0)
InParty(Myself) !StateCheck(Myself,CD_STATE_NOTVALID)
InParty("SOLAUFEIN") InMyArea("SOLAUFEIN") !StateCheck("SOLAUFEIN",CD_STATE_NOTVALID)
CombatCounter(0) !See([ENEMY])~
THEN C-ARANB c-solaufein1arantalk-solaufeindv
@12 /* [ARAN] Blighted stone. Got one in my boot, I do. */
DO ~SetGlobal("c-solaufein1aran","GLOBAL",1)~
== BSOLA @13 /* [SOLAUFEIN] Ah, my prejudiced fellow traveller - speech is a mirror of the soul. As a man speaks, so is he. I ask you now: who is Aran? */
== C-ARANB @14 /* [ARAN] I don't rightly understand th' question. Wait... mayhap I do. Do you be sayin' th' way a man speaks be a good indication o' his personality, his habits, an' so forth? */
