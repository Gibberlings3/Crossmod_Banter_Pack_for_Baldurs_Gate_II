...
== BKIDO25 IF ~!Global("TsujathaRomanceActive","GLOBAL",2)~ THEN @4 /* Well, that was a very unsastifising conversation. However, I will put you on the neutral list then. */
...
== BKIDO25 IF ~Global("TsujathaRomanceActive","GLOBAL",2)~ THEN @7 /* What else? Of course I do! */
...
== BKIDO25 IF ~Global("TsujathaRomanceActive","GLOBAL",2)~ THEN @9 /* Well, that was a very sastifising conversation. It seems that we will stand side by side in the end. */
...
== BKIDO25 @12 /* I feel indeed quite honored by it. However, I wouldn't mind getting some more powerful items. Great fights await us, and it would be a shame to let the lore of making rings, such as yours, die. Why do you not share your lore with me? */
...
== BKIDO25 @14 /* Ha! Can you be sure of that, dear Tsujatha? Indeed my natural lifespan is shorter. However, the Highest of High is on my side, and thus nothing is certain. Isn't it fun? Uncertainty gives a thrill to life, don't you agree? Besides, I do not fear death. I have at least lived before I die! I doubt you can say that much. */
