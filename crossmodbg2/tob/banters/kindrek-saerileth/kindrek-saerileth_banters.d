...
== BSAERI25 ~Get thee gone, and come not near me!~
== BKINDR25 ~You do not mean that, little flower!  Come and let me pollenate you! I will make you fruitful.~
== BSAERI25 ~I would bear no fruit of thine!  <CHARNAME>, I cannot endure the shame he doth heap upon me.  (Saerileth blushes crimson and turns away.)~
END
+ ~Global("SaerilethRomanceActive","GLOBAL",2)~ + ~Kindrek, you villain!  How dare you speak to my wife in such a fashion!  Leave now.~ EXTERN BKINDR25 KindSaerToBBanter#1.2
+ ~Global("SaerilethRomanceActive","GLOBAL",2)~ + ~Kindrek, you bastard!  I will kill you for dishonoring my wife!~ EXTERN BKINDR25 KindSaerToBBanter#1.3
+ ~OR(2)
Global("SaerilethRomanceActive","GLOBAL",0)
Global("SaerilethRomanceActive","GLOBAL",3)~ + ~Kindrek, that was uncalled for.  I want you to leave now.~ EXTERN BKINDR25 KindSaerToBBanter#1.4
+ ~OR(2)
Global("SaerilethRomanceActive","GLOBAL",0)
Global("SaerilethRomanceActive","GLOBAL",3)~ + ~Saerileth, you're too sensitive.  He's just having some fun.~ EXTERN BSAERI25 KindSaerToBBanter#1.5
...
SAY ~The game's afoot!  I will kill you, then ravish your new bride and use your freshly-killed corpse as our pillow!~
IF ~~ THEN DO ~EquipMostDamagingMelee()
LeaveParty()
Enemy()
Attack(LastSeenBy())~ EXIT
